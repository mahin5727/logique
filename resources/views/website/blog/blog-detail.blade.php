            ...
            <div class="col-lg-8">
                ...
                <div class="bg-light mb-3" style="padding: 30px;">
                    ...
                    <div class="media mb-4">
                        <img src="{{asset('blog-assets/img/user.jpg')}}" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div class="media mt-4">
                                <img src="{{asset('blog-assets/img/user.jpg')}}" alt="Image" class="img-fluid mr-3 mt-1"
                                    style="width: 45px;">
                                <div class="media-body">
                                    <h6><a href="">John Doe</a> <small><i>01 Jan 2045 at 12:00pm</i></small></h6>

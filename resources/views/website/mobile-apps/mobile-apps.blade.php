                        ...
                        <div class="container py-5">
                            <div class="row gx-0 d-flex justify-content-center">
                                ...
                                <div class="col-lg-8 col-12 px-4 align-items-center ">
                                    ...
                                    <h2 class="h2 pt-2 text-custom">Why Choose React?</h2>
                                    ...
                                    <h2 class="h2 pt-2 text-custom">Tailored Solutions for Every Vision</h2>
                                    ...
                                    <h2 class="h2 pt-2 text-custom">More than Just Code</h2>
                                    ...
                                    <h2 class="h2 pt-2 text-custom">Our Mobile App Development Services</h2>
                                    <h2 class="h2 pt-2 text-custom">What Sets Us Apart</h2>
                                    <ul>
                                        <li>
                                    ...
                                    <h2 class="pt-2 text-custom">Ready to Get Started?</h2>
                                    <p class="py-3">
